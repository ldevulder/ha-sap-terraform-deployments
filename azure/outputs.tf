...
output openqa_vms {
  value = concat(module.drbd_node.drbd_id, module.hana_node.cluster_nodes_id, module.netweaver_node.netweaver_id)
}

output openqa_ips {
  value = concat(module.drbd_node.drbd_public_ip, module.hana_node.cluster_nodes_public_ip, module.netweaver_node.netweaver_public_ip)
}
